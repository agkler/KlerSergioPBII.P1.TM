...
class PrimerParcial2021 {
	...
	void queSePuedaCrearUnaPelicula() {
		...
		// Validación
		assertEquals(CODIGO_ESPERADO, pelicula.getCodigoPelicula());
		assertEquals(DESCRIPCION_ESPERADA, pelicula.getDescripcionPelicula());
		assertEquals(GENERO_ESPERADO, pelicula.getGeneroPelicula());
		assertEquals(ANO_DE_ESTRENO_ESPERADO, pelicula.getAnoDeEstreno());
		assertEquals(DIRECTOR_ESPERADO, pelicula.getDirectorPelicula());
